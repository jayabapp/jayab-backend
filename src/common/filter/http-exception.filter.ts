...
const failedMessages = {
  ...
  COMMON6: 'مقادیر ارسالی اشتباه هستند',
  ...
  AUTH10: 'اکانت شما غیر فعال شده است. لطفا با پشتیبانی تماس بگیرید',
  TEST_ACCESS_DENIED: 'در صورت مجاز بودن حساب، کد ورود برای شما صادر می‌شود.',
  TEST_ACCESS_FORBIDDEN: 'شما اجازه مدیریت دسترسی محیط تست را ندارید.',
  TEST_ACCESS_ALREADY_EXISTS: 'این شماره از قبل در فهرست دسترسی وجود دارد.',
  TEST_ACCESS_MEMBER_NOT_FOUND: 'عضو مورد نظر یافت نشد.',
  TEST_ACCESS_TEAM_LEAD_PROTECTED: 'دسترسی تیم لید قابل تغییر نیست.',
  ...
  BUY_SUBSCRIPTION1: 'خرید اشتراک عادی برای کاربران ویژه امکان پدیر نمی‌باشد',
  BUY_SUBSCRIPTION2: 'آگهی شما منقضی شده است و امکان نردبان ندارد',
  BUY_SUBSCRIPTION3: 'پلنی انتخاب نشده است',

  SUBSCRIPTION1: 'اشتراک فعالی یافت نشد',
  REGISTER1: 'این درخواست قبلا توسط شما انجام شده',
  REGISTER2: 'کد ملی توسط شخص دیگری ثبت شده است',
  REGISTER3: 'اکانت شما تایید شده است و امکان ویرایش اطلاعات را ندارید',
  REGISTER4: 'کد معرف برای ثبت مشاور ویژه الزامی است',
  REGISTER5: 'کد معرف اشتباه است',

  TICKET1: 'نمی توانید بیشتر از ۱۰ تیکت باز داشته باشید',
  TICKET2: 'امکان ارسال پاسخ به تیکت بسته شده وجود ندارد',
  ...
  CHAT9: 'شما امکان ارسال پیام به این کاربر را ندارید',
  CHAT10: 'امکان ارسال پیام وجود ندارد',
  CHAT11: 'امکان ارسال شماره موبایل در پیام وجود ندارد',
  CHAT12: 'امکان ارسال تصویر برای این چت وجود ندارد',
  CHAT13: 'شما با شماره دیگری این آگهی را ثبت کرده‌اید، جهت مشاهده پیام‌ها با همان خط وارد برنامه شوید.',
  ...
  PROPERTY2: 'ثبت حداقل یک شماره تماس معتبر الزامی است',
  ...
  CALL_LOG1: 'حد مجاز نمایش اطلاعات تماس برای شما به پایان رسیده است .',
  CALL_LOG2: 'کاربر گرامی اکانت شما به دلیل جمع آوری بیش از حد مجاز اطلاعات مسدود گردید',

  REPORT1: 'شما قبلا گزارش ثبت کرده اید',

  MIAN1: 'شماره موبایل مورد نظر در سیستم وجود ندارد',

  RESERVE1: 'تاریخ شروع و پایان نمیتواند یکسان باشد',
  RESERVE2: 'تاریخ شروع و پایان اشتباه است',
  RESERVE3: 'تاریخ شروع پیش از امروز نمی تواند باشد',
