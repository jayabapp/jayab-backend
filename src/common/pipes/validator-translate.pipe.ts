...
const VM = {
  ...
  Min: (title: string): string => `حداقل مقدار ${title} باید $constraint1 باشد`,
  Max: (title: string): string => `حداکثر مقدار ${title} باید $constraint1 باشد`,
...
export const PROPS = {
  ...
  check_in_hour: 'ساعت ورود',
  check_out_hour: 'ساعت خروج',
  guest_dscr: 'توضیحات پذیرش نوع مهمان',
  pet_dscr: 'توضیحات ورود حیوان خانگی',
  party_dscr: 'توضیحات برگزاری مراسم',
  doc_dscr: 'مدارک مورد نیاز جهت پذیرش',
  other_dscr: 'سایر توضیحات',
  property_dscr: 'توضیحات ملک',
};
