import { AccessControlList, PropertyCalendarNote, Prisma } from '@prisma/client';
import {
  AvailableAction,
  Column,
  CreateProps,
...
type ModelFields = keyof typeof RefEnum | keyof typeof Prisma.PropertyCalendarNoteScalarFieldEnum;
...
/*                                    SHOW                                    */
/* -------------------------------------------------------------------------- */
export const showPropsBuilder = (item: PropertyCalendarNote): Array<ShowProps> => {
...
/* --------------------------------- ACTIONS -------------------------------- */
export const showActionBuilder = (item: PropertyCalendarNote): Array<ShowAction> => {
