...
import { FindAllLandingPageAdminDto } from 'src/landing-page/roles/admin/dto/find-all.dto';
 ...
 * @returns
 */
export const filterValidator = (filters: FindAllLandingPageAdminDto): Prisma.LandingPageWhereInput => {
  if (!filters) return {};
