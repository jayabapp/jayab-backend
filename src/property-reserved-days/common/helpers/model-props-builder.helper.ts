import { AccessControlList, PropertyReservedDays, Prisma } from '@prisma/client';
import {
  AvailableAction,
  Column,
  CreateProps,
...
type ModelFields = keyof typeof RefEnum | keyof typeof Prisma.PropertyReservedDaysScalarFieldEnum;
...
/*                                    SHOW                                    */
/* -------------------------------------------------------------------------- */
export const showPropsBuilder = (item: PropertyReservedDays): Array<ShowProps> => {
...
/* --------------------------------- ACTIONS -------------------------------- */
export const showActionBuilder = (item: PropertyReservedDays): Array<ShowAction> => {
