...
type ModelFields = keyof typeof RefEnum | keyof typeof Prisma.PaymentGatewayScalarFieldEnum;
...
/*                                    SHOW                                    */
/* -------------------------------------------------------------------------- */
export const showPropsBuilder = (item: PaymentGateway): Array<ShowProps> => {
...
/* --------------------------------- ACTIONS -------------------------------- */
export const showActionBuilder = (item: PaymentGateway): Array<ShowAction> => {
...
export const tablePropsBuilder = (availableActions: Array<AvailableAction>): ModifiedTableProps => {
  const tableProps: ModifiedTableProps = {
    ...
    columns: [
      ...
      { id: 40, title: 'فعال باشد؟', key: 'is_active', cellType: 'boolean', isEditable: true },
      /* ---------------------------------- date ---------------------------------- */
