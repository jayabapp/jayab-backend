...
import { FindAllSubmittedFormAdminDto } from 'src/submitted-form/roles/admin/dto/find-all.dto';
 ...
 * @returns
 */
export const filterValidator = (filters: FindAllSubmittedFormAdminDto): Prisma.SubmittedFormWhereInput => {
  if (!filters) return {};
  ...
  let query: Prisma.SubmittedFormWhereInput = {};
