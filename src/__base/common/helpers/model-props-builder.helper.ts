...
type ModelFields = keyof typeof RefEnum | keyof typeof Prisma.BaseScalarFieldEnum;
...
/*                                    SHOW                                    */
/* -------------------------------------------------------------------------- */
export const showPropsBuilder = (item: Base): Array<ShowProps> => {
...
/* --------------------------------- ACTIONS -------------------------------- */
export const showActionBuilder = (item: Base): Array<ShowAction> => {
