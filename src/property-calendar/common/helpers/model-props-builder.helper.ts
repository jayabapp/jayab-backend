import { AccessControlList, PropertyCalendar, Prisma } from '@prisma/client';
import {
  AvailableAction,
  Column,
  CreateProps,
...
type ModelFields = keyof typeof RefEnum | keyof typeof Prisma.PropertyCalendarScalarFieldEnum;
...
/*                                    SHOW                                    */
/* -------------------------------------------------------------------------- */
export const showPropsBuilder = (item: PropertyCalendar): Array<ShowProps> => {
...
/* --------------------------------- ACTIONS -------------------------------- */
export const showActionBuilder = (item: PropertyCalendar): Array<ShowAction> => {
